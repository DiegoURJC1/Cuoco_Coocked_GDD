...
export default function AppearancePage() {
    return (
        <>
            ...
            y disfrutado, pero el contexto es violento y absurdo. Esta contradicción no se resuelve se explota como motor de identidad.
            <br></br>
            <p>
            <Heading3>Principios de art direction</Heading3>
            <ul>
                <li><b>Food styling como lenguaje visual base:</b>
                    <p>
                        ...
                        deben evocar apetito: gloss en las salsas, subsurface scattering en masas y carnes, vapor, brillo
                ...
                <li><b>Saturación alta, contraste controlado:</b>
                    <p>
                        ...
                        los aderezos deben tener sus propios lenguajes cromáticos claramente diferenciados y reconocibles
                        por el jugador.
                    </p>
                </li>
            ...
            <Heading3>Menús y pantallas</Heading3>
            <p>
                <ul>
                ...
                <p>
                    ...
                    <ul>
                        <li><b>Absurdo desenfadado</b>: La premisa nunca se toma en serio a sí misma, pero el sistema de
                            combate sí es sólido y tiene profundidad real.</li>
                        <li>La comedia emerge de la coherencia interna: un plato de boloñesa que te agarra con los fideos
                            es ridículo y al mismo tiempo tiene una lógica impecable dentro del universo.</li>
                    </ul>
                </p>
            </p>
            <hr></hr>
            ...
            <p>
                ...
                <ul>
                    <li>Guilty Gear Strive: Identidad visual fuerte y disruptiva como declaración de intenciones del género</li>
                    <li>Skullgirls: Personajes con identidad visual completamente original dentro del género</li>
                    <li>Food photography / Instagram food styling: Iluminación, paleta, composición visual de personajes y escenarios</li>
